...
/* Validation and blocking reasons. These reach a parent mid-checkout, so they
  ...
  enrollDates: {
    ...
    bonusTitle: { en: "Extra Bonus — all 12 sessions", zh: "额外优惠——全部12次课" },
    bonusBody: {
      en: "Select all 12 sessions for this package and we will take an extra $30 off when we collect payment. Each sibling on this package earns their own $30.",
      zh: "本套餐选择全部12次课，收取费用时我们将额外减免 $30。每位选择本套餐的孩子均可各自获得 $30 优惠。",
    },
    bonusEarned: {
      en: "All 12 sessions selected — your $30 Extra Bonus will be applied when we collect payment.",
      zh: "已选择全部12次课——收取费用时将为您减免 $30 额外优惠。",
    },
...
enrollReg: {
    ...
    consistencyRow: { en: "Extra Bonus ({n} child)", zh: "额外优惠（{n} 名学生）" },
    ...
    saveConsistency: { en: "{amount} Extra Bonus", zh: "额外优惠 {amount}" },
