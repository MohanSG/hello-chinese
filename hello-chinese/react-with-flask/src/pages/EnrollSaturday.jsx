...
function BookIcon() {
  return (
    ...
    >
      <path
        d="M4 5.5C6 4.5 9 4.5 11 5.5V19C9 18 6 18 4 19V5.5Z"
        stroke="#2f8a4e"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path
        d="M20 5.5C18 4.5 15 4.5 13 5.5V19C15 18 18 18 20 19V5.5Z"
        stroke="#2f8a4e"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
function EnrollSaturday() {
  ...
  const submitInterest = async (e) => {
    ...
    try {
      await apiRequest("/saturday_interest", {
        method: "POST",
        body: JSON.stringify({
          payload,
        }),
        ...
        <section className="enroll-header">
          ...
          <div className="enroll-header__inner enroll-confirm">
            ...
            <p className="enroll-header__desc enroll-confirm__desc">
              We'll email you as soon as Saturday enrollment opens, with final
              schedule, pricing, and teacher details.
            </p>
    ...
    <div className="enroll-overview">
      ...
      <section className="enroll-header">
        ...
        <div className="enroll-header__inner">
          ...
          <h1 className="enroll-header__title">
            Saturday Programs Interest List
          </h1>
          <p className="enroll-header__desc">
            English Language Learning and English-Led Math Enrichment are
            launching soon. Tell us who you're enrolling and we'll notify you
            the moment registration opens — schedule, pricing, and teachers to
            be announced.
          </p>
        </div>
      </section>
      ...
      <div className="sat-interest">
          ...
          {PROGRAM_CARDS.map((c) => (
            ...
            >
              <div className="sat-program__head">
                <div
                  className={`sat-program__icon sat-program__icon--${c.icon}`}
                >
              ...
              <div className="sat-program__list">
                {c.bullets.map((b) => (
                  <span key={b} className="sat-program__item">
                    <span className="sat-program__check">✓</span>
                    {b}
                  </span>
                ))}
              </div>
        ...
        <form className="sat-form" onSubmit={submitInterest}>
          <div className="sat-form__grid">
            ...
            <label className="field">
              ...
              <input
                type="text"
                name="childAgeGrade"
                placeholder="e.g. Age 7 / 2nd grade"
            ...
            <label className="field field--full">
              ...
              >
                ...
                <option value="English Language Learning">
                  English Language Learning
                </option>
                <option value="English-Led Math Enrichment">
                  English-Led Math Enrichment
                </option>
            ...
            <label className="field field--full">
              <span className="field__label">
                Comments <span className="field__optional">(optional)</span>
              </span>
              <textarea
                name="comments"
                rows="4"
          ...
          <p className="sat-form__note">
            No enrollment or payment yet — this only adds you to the
            notification list.
          </p>
        </form>
      </div>
