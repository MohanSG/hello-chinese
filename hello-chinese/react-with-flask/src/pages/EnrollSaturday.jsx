    ...
    <div className="enroll-overview">
      ...
      <section className="enroll-header">
        <div className="enroll-header__inner">
          ...
          <span className="enroll-badge enroll-badge--soon">
            {t("enrollCommon.comingSoon")}
          </span>
          ...
          {PROGRAM_CARDS.map((c) => (
            ...
            >
              <div className="sat-program__head">
                ...
                <div>
                  <h3 className="sat-program__title">
                    {t(`enrollSat.${c.key}Title`)}
                  </h3>
                  <p className="sat-program__desc">
                    {t(`enrollSat.${c.key}Desc`)}
                  </p>
                </div>
              </div>
          ...
          <div className="sat-form__grid">
            ...
            <label className="field">
              ...
              <input
                type="email"
                name="email"
                placeholder={t("enrollSat.emailPlaceholder")}
                value={form.email ?? ""}
                onChange={onField}
                className="field__input"
              />
            ...
            <label className="field">
              <span className="field__label">
                {t("enrollSat.childAgeGrade")}
              </span>
              <input
                type="text"
                name="childAgeGrade"
                placeholder={t("enrollSat.childAgeGradePlaceholder")}
            ...
            <label className="field field--full">
              ...
              >
                ...
                <option value="English Language Learning">
                  {t("enrollSat.englishTitle")}
                </option>
                <option value="English-Led Math Enrichment">
                  {t("enrollSat.mathTitle")}
                </option>
            ...
            <label className="field field--full">
              <span className="field__label">
                {t("enrollSat.preferredTime")}{" "}
                <span className="field__optional">
                  {t("enrollSat.optional")}
                </span>
              </span>
              <input
                type="text"
                name="preferredTime"
                placeholder={t("enrollSat.preferredTimePlaceholder")}
